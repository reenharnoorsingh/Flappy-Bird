...
BACKGROUND = "gallery/sprites/bg2.png"
...
def mainGame():
    ...
    playerVelY = -9  # player velocity
    playerMaxVelY = 10  # maximum player velocity
    playerMinVelY = -8  # minimum player velocity
    playerAccY = 1  # player accelaration
...
if __name__ == "__main__":
    ...
    GAME_SPRITES['message'] =pygame.image.load('gallery/sprites/tile.png').convert_alpha()
